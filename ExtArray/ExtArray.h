...
/// Включить проверки на выход индексов за границы массива в Release.
#define MODULTE_EXT_ARRAY_ENABLE_OUT_OF_RANGE true
	...
	*/
	...
	public:
		...
		*/
		...
		/**
		 * @brief Добавить элемент в конец расширяющегося массива.
		 * 
		 * Функция копирует содержимое elem в конец массива.
		 * 
		...
		*/
		 ...
		 * @brief Добавить элемент в конец расширяющегося массива.
		 * 
		 * Функция перемещает содержимое elem в конец массива.
		 * 
		 * В случае нехватки памяти для добавления элемента, будет автоматически выделен
		 * новый блок памяти размером в EXT_ARRAY_RESIZE_MULTIPLIER раз больше старого. 
		 * Добавленные ранее элементы будут скопированы в новый блок памяти. После этого
		...
		*/
		...
		/**
		 * @brief Удалить элемент с конца массива.
		 * 
		 * Функция уменьшает счётчик текущего количества элементов массива и возвращает
		 * ссылку на удалённый элемент, который будет перезаписан при вызове PushBack() или
		 * стёрт при вызове Resize().
		 * 
...
#undef MODULTE_EXT_ARRAY_ENABLE_OUT_OF_RANGE
