...
namespace UtilLib
{
    ...
    */
    #define LogLine(message, logLevel, sig, dublicateToConsole) \
        LogLine(message, logLevel, sig, dublicateToConsole, FUNCTION_SIGNATURE, __FILE__, __LINE__)
    ...
    */
    #define LogFLine(logLevel, sig, dublicateToConsole, format, ...) \
        LogFLine(logLevel, sig, dublicateToConsole, FUNCTION_SIGNATURE, __FILE__, __LINE__, format, __VA_ARGS__)
    ...
    */
    #define LogAddTrace(sig, trace) \
        LogAddTrace(sig, trace, FUNCTION_SIGNATURE, __FILE__, __LINE__)
    ...
    */
    #define LogBeginDump(sig, lvl) \
        LogBeginDump(sig, lvl, FUNCTION_SIGNATURE, __FILE__, __LINE__)
